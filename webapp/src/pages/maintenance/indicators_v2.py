...
TRANS = {
    "pt": {
        ...
        # Heatmap (IM-20/21/22)
        "btn_thresholds":         "Gatilhos",
        "heatmap_section_title":  "Heatmap de Falhas",
        "heatmap_section_sub":    "Calendário por duração de paradas — cor varia conforme a mediana da referência.",
        "heatmap_planta_title":   "Planta",
        "heatmap_grid_title":     "Por equipamento",
        "switch_lwb":             "Simular erro LWB (SOLDA001)",
        "switch_hide_tooling":    "Sem ferramentaria (202 / S202)",
        "heat_view_self":         "Visão individual (cada equipamento vs sua própria mediana)",
        "heat_view_planta":       "Visão geral (todos comparados à mediana da planta)",
        # Heatmap — KPI cards (4) + stats + legend + tooltips
        "heat_kpi_dist_mean_title":   "Distribuição vs Média",
        "heat_kpi_dist_median_title": "Distribuição vs Mediana",
        "heat_kpi_sum_mean_title":    "Tempo total vs Média",
        "heat_kpi_sum_median_title":  "Tempo total vs Mediana",
        "heat_ref_media":             "Média:",
        "heat_ref_mediana":           "Mediana:",
        "heat_below_paradas":         "Paradas abaixo",
        "heat_above_paradas":         "Paradas acima",
        "heat_below_tempo":           "Tempo abaixo",
        "heat_above_tempo":           "Tempo acima",
        "heat_stats_media":           "Média",
        "heat_stats_mediana":         "Mediana",
        "heat_stats_vs_planta":       "vs planta",
        "heat_no_paradas_periodo":    "Sem paradas no período",
        "heat_sem_producao":          "Sem produção",
        "heat_sem_paradas":           "Sem paradas",
        "heat_total":                 "Total",
        "heat_fora_filtro":           "Fora do filtro selecionado",
        # Chart traces / titles
    ...
    "es": {
        ...
        # Heatmap (IM-20/21/22)
        "btn_thresholds":         "Umbrales",
        "heatmap_section_title":  "Mapa de Calor de Fallas",
        "heatmap_section_sub":    "Calendario por duración de paradas — el color varía según la mediana de referencia.",
        "heatmap_planta_title":   "Planta",
        "heatmap_grid_title":     "Por equipo",
        "switch_lwb":             "Simular error LWB (SOLDA001)",
        "switch_hide_tooling":    "Sin herramentaría (202 / S202)",
        "heat_view_self":         "Vista individual (cada equipo vs su propia mediana)",
        "heat_view_planta":       "Vista general (todos comparados con la mediana de la planta)",
        "heat_kpi_dist_mean_title":   "Distribución vs Media",
        "heat_kpi_dist_median_title": "Distribución vs Mediana",
        "heat_kpi_sum_mean_title":    "Tiempo total vs Media",
        "heat_kpi_sum_median_title":  "Tiempo total vs Mediana",
        "heat_ref_media":             "Media:",
        "heat_ref_mediana":           "Mediana:",
        "heat_below_paradas":         "Paradas debajo",
        "heat_above_paradas":         "Paradas arriba",
        "heat_below_tempo":           "Tiempo debajo",
        "heat_above_tempo":           "Tiempo arriba",
        "heat_stats_media":           "Media",
        "heat_stats_mediana":         "Mediana",
        "heat_stats_vs_planta":       "vs planta",
        "heat_no_paradas_periodo":    "Sin paradas en el período",
        "heat_sem_producao":          "Sin producción",
        "heat_sem_paradas":           "Sin paradas",
        "heat_total":                 "Total",
        "heat_fora_filtro":           "Fuera del filtro seleccionado",
    ...
    "en": {
        ...
        "heatmap_section_title":  "Failures Heatmap",
        "heatmap_section_sub":    "Calendar by breakdown duration — color reflects the reference median.",
        "heatmap_planta_title":   "Plant",
        "heatmap_grid_title":     "By equipment",
        "switch_lwb":             "Simulate LWB error (SOLDA001)",
        "switch_hide_tooling":    "No tooling (202 / S202)",
        "heat_view_self":         "Individual view (each equipment vs its own median)",
        "heat_view_planta":       "Global view (all compared to plant median)",
        "heat_kpi_dist_mean_title":   "Distribution vs Mean",
        "heat_kpi_dist_median_title": "Distribution vs Median",
        "heat_kpi_sum_mean_title":    "Total time vs Mean",
        "heat_kpi_sum_median_title":  "Total time vs Median",
        "heat_ref_media":             "Mean:",
        "heat_ref_mediana":           "Median:",
        "heat_below_paradas":         "Stops below",
        "heat_above_paradas":         "Stops above",
        "heat_below_tempo":           "Time below",
        "heat_above_tempo":           "Time above",
        "heat_stats_media":           "Mean",
        "heat_stats_mediana":         "Median",
        "heat_stats_vs_planta":       "vs plant",
        "heat_no_paradas_periodo":    "No breakdowns in this period",
        "heat_sem_producao":          "No production",
        "heat_sem_paradas":           "No breakdowns",
        "heat_total":                 "Total",
        "heat_fora_filtro":           "Outside selected filter",
        "chart_trend":   "Trend",
        "chart_target":  "Target",
        "chart_value":   "Value",
        "chart_status":  "Status",
        ...
        [
            ...
            dbc.Collapse(
                dbc.Card(
                                ...
                                dbc.Col(
                                    [
                                        ...
                                        dcc.DatePickerRange(
                                            ...
                                            className="d-block v2-date-range-inline",
                                            minimum_nights=0,
                                        ),
                                    ],
                                    md=4,
                    ...
                    # Footer da card: Aplicar alinhado à direita, em linha separada
                    dbc.CardFooter(
                        dbc.Button(
                        ...
                        className="d-flex justify-content-end bg-transparent border-0 pt-0",
                    ),
                    ],
                        ...
                        children=html.Div(
                            [
                                ...
                                dbc.Card(
                                    ...
                                    className="shadow-sm mb-4 indicator-v2-card-static",
                                    style={"borderTop": "4px solid #fd7e14"},
                                ),
                                        ...
                                        [
                                            html.P(
                                                [
                                                    ...
                                                    " X%–Z% · ",
                                                    html.Span("Vermelho forte", style={"backgroundColor": "#c82333", "color": "white", "padding": "0 6px"}),
                                                    " > Z% (X=100 = mediana, Z=alerta intenso).",
                                                ],
                                                className="text-muted small mb-3",
                                            ),
                                            dbc.Row(
                                                [
                                                    ...
                                                    dbc.Col(
                                                        [
                                                            html.Label("X% (mediana / vermelho)",
                                                                       className="form-label small fw-semibold"),
                                                            dbc.Input(
                                                                id="input-heatmap-x-pct",
                                                                type="number",
                                                                min=2, max=299, step=1,
                                                                placeholder="100",
                                                            ),
                                                        ],
                                                        md=4,
                                                    ...
                                                    dbc.Col(
                                                        [
                                                            html.Label("Z% (vermelho forte)",
                                                                       className="form-label small fw-semibold"),
                                                            dbc.Input(
                                                                id="input-heatmap-z-pct",
                                                                type="number",
