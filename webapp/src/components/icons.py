...
# Adicionamos uma classe CSS 'menu-icon' a todos os ícones.
# Também removemos a classe 'me-2' daqui para centralizar o estilo no CSS.
...
'''
    # Apenas o ícone, sem classes extras por enquanto.
...
def filter_icon():
    """Retorna um componente SVG para o ícone de filtro (funil)."""
    svg_string = f'''
