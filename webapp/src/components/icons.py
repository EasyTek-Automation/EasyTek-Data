...
# ======================================================================================
# NOVOS ÍCONES (ADICIONADOS) — sem alterar os existentes acima
# ======================================================================================

def home_icon():
    """Retorna um componente SVG para o ícone de Início (casa)."""
    svg_string = f'''
...
def maintenance_icon():
    """Retorna um componente SVG para o ícone de Manutenção (chave inglesa)."""
    svg_string = f'''
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-wrench-adjustable" viewBox="0 0 16 16">
  <path d="M16 4.5a4.5 4.5 0 0 1-1.703 3.526L13 5.5l-2.354-1.854A4.5 4.5 0 0 1 8 2.5a4.5 4.5 0 0 1 8 2M11.5 9c.653 0 1.273-.139 1.833-.39L12 10.5 9.5 13H8l.5-.5 3-3z"/>
  <path d="M9 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM0 4.5A1.5 1.5 0 0 1 1.5 3h5A1.5 1.5 0 0 1 8 4.5v7A1.5 1.5 0 0 1 6.5 13h-5A1.5 1.5 0 0 1 0 11.5zm1.5-.5a.5.5 0 0 0-.5.5v7a.5.5 0 0 0 .5.5h5a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.5-.5z"/>
</svg>
'''
    return dcc.Markdown(svg_string, dangerously_allow_html=True, className="menu-icon")

def production_icon():
    """Retorna um componente SVG para o ícone de Produção (gear-wide)."""
    svg_string = f'''
...
def energy_icon():
    """Retorna um componente SVG para o ícone de Energia (raio)."""
    svg_string = f'''
...
def alarm_icon():
    """Retorna um componente SVG para o ícone de Alarmes (sino)."""
    svg_string = f'''
...
def report_icon():
    """Retorna um componente SVG para o ícone de Relatórios (arquivo/texto)."""
    svg_string = f'''
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-text" viewBox="0 0 16 16">
  <path d="M5 4a.5.5 0 0 0 0 1h6a.5.5 0 0 0 0-1H5zm-.5 2.5A.5.5 0 0 1 5 6h6a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5M5 8a.5.5 0 0 0 0 1h6a.5.5 0 0 0 0-1H5zm0 2a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1z"/>
